    ...
    return(
        <MotionDisplayWrapper>
            <div className='space-y-4 overflow-auto'> 
                <h3 className="font-semibold text-purple-700">Review your answers</h3>
                                ...
                                <div key={quest}>
                                    <div className={`w-full place-items-center`}>
                                        <div className='w-full space-y-4 border border-opacity-10 rounded-lg'>
                                            <h1 className='font-mono p-4 bg-cyan-500/20 rounded-t-lg max-w-full overflow-auto text-purple-900/90 font-semibold'>{`${i + 1}. ${quest}`}</h1>
                                            <div className='w-full max-w-full overflow-auto grid grid-cols-1 '>
                                                {
                                                    options.map(({label, value}) => (
                                                        ...
                                                        >
                                                            ...
                                                            <h3 className={`${userAnswer?.label === label && userAnswer?.label !== correctAnswer.label? 'absolute right-0 top-0 text-red-500 ' : 'hidden'}`}>Wrong</h3>
