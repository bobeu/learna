...
export function Quiz({ selectAnswer } : {selectAnswer: (arg : {label: string}) => void}) {
  ...
  return (
    <MotionDisplayWrapper className="w-full relative bg-cyan-500 p-4 rounded-lg ">
              ...
              <div className={`w-full h-fit`}>
                {
                  <div className='w-full space-y-4'> 
                      <h3 className='font-mono bg-white p-4 rounded-lg max-w-full overflow-auto font-semibold text-cyan-800'>{`${index + 1 }. ${question}`}</h3>
