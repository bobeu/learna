...
// import { FormattedData, Eligibility as Elg} from "../../../types/quiz";
...
//     const { hash_, erc20Amount, nativeAmount, isEligible, token, weekId } = eligibility || mockEligibility;
//     const { campaignData } = useStorage();
//     const myCampaign = campaignData?.filter(q => q.hash_.toLowerCase() === hash_?.toLowerCase());
...
//                 <div className="glass-card rounded-xl p-4">
//                     <div className="flex items-center justify-center mb-3">
//                         <Verified className={`w-8 h-8 ${isEligible? 'text-green-600' : 'text-orange-600'}`} />
//                     </div>
//                     <div className="text-xl text-gray-800 mb-1">
//                         {isEligible? 'Verified' : 'No claim'}
//                     </div>
...
//     const { campaignStrings, campaignData,  } = useStorage();
