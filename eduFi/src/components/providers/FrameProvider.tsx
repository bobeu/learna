...
//   // Add miniapp
//   const createCast = useCallback(async(text: string, embeds: [string], channelKey: string) => {
//     const resul = await sdk.actions.composeCast({ 
...
//     if (resul?.cast) {
//       console.log(resul.cast.hash)
//       console.log(resul.cast.channelKey) // includes channel if posted to one
//     }
...
//     return (
//         <MotionDisplayWrapper className='relative h-full w-full bg-cyan-500/30'>
