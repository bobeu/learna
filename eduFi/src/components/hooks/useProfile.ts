...
// import { filterTransactionData, formatAddr, mockCampaign, mockClaimResult, mockHash, mockProfile, mockReadProfile, mockWeekProfileData, toBN } from '../utilities';
...
// // type StateData = { weekProfileData: WeekProfileData[], claimables: ClaimResult[] }
...
//     const [ requestedHash, setRequestedHash ] = React.useState<Hex>(mockHash);
...
//     // const { weekData, weekProfileData, claimables } = useStorage();
...
//     // }, [weekProfileData, claimables, weekData, requestedHash, requestedWkId]);
...
//     return { formattedData, setHash, setWeekId } 
