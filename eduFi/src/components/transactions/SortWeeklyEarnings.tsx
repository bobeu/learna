...
export default function SortWeeklyReward({growTokenAmount, newInterval, openDrawer, toggleDrawer }: SortWeeklyRewardProps) {
    ...
    }, [chainId, callback, growTokenAmount, newInterval]);
