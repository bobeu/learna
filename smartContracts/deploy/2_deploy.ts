...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
	...
	*/
	 ...
	 */
	const tokenv2 = await deploy("GrowTokenV2", {
		from: deployer,
	...
	try {
		...
		// await execute('LearnaV2', {from: deployer}, 'setToken', GrowToken.address);
		// await execute('GrowTokenV2', {from: deployer}, 'setMain', learna.address);
		...
		// 	await execute('GrowTokenV2', {from: deployer}, 'setPermission', newAdmins[i]);
		// }
	} catch (error) {
