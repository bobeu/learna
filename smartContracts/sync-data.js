...
const approvedFunctions = ['checkEligibility', 'recordPoints', 'banUserFromCampaign', 'setAdmin', 'getAdminStatus', 'hasPassKey', 'setTransitionInterval', 'claimReward', 'sortWeeklyReward', 'adjustCampaignValues', 'setUpCampaign', 'getProfile', 'generateKey', 'getData', 'approve', 'setMinimumToken', 'owner', 'allowance', 'pause', 'unpause', 'claimReward', 'setScope', 'setConfigId', 'getClaimable', 'configId'];
const readFunctions = ['getProfile',  'getData', 'checkligibility', 'hasPassKey', 'getAdminStatus', 'owner', 'allowance', 'getClaimable', 'configId'];
