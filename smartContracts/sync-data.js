...
const approvedFunctions = ['setCreationFee', 'setFeeTo', 'setVerifier', 'setApprovalFactory', 'createCampaign', 'getUserCampaigns', 'getData', 'hasApproval', 'removeApproval', 'setApproval', 'setFactory', 'getFactory', 'verify', 'verifyByApprove', 'toggleUseWalletVerification', 'banOrUnbanUser', 'getVerificationStatus', 'panicWithdraw', 'withdraw'];
const approveTemplateFunctions = ['getData', 'addFund', 'updatePoints', 'claimReward', 'proveAssimilation', 'epochSetting', 'pause', 'unpause'];
