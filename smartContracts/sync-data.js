...
const approvedFunctions = ['checkEligibility', 'recordPoints', 'banUserFromCampaign', 'setAdmin', 'getAdminStatus', 'setTransitionInterval', 'sortWeeklyReward', 'adjustCampaignValues', 'setUpCampaign', 'getProfile', 'getData', 'approve', 'setMinimumToken', 'owner', 'allowance', 'pause', 'unpause', 'claimReward', 'setScope', 'setConfigId', 'getClaimable', 'configId', 'unbanUserFromCampaign'];
const readFunctions = ['getProfile',  'getData', 'checkligibility', 'getAdminStatus', 'owner', 'allowance', 'getClaimable', 'configId'];
