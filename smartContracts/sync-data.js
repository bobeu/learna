...
const approvedFunctions = ['checkEligibility', 'recordPoints', 'banUserFromCampaign', 'setAdmin', 'getAdminStatus', 'hasPassKey', 'setTransitionInterval', 'claimReward', 'sortWeeklyReward', 'adjustCampaignValues', 'setUpCampaign', 'getProfile', 'generateKey', 'getData', 'approve', 'setMinimumToken', 'owner'];
const readFunctions = ['getProfile',  'getData', 'checkligibility', 'hasPassKey', 'getAdminStatus', 'owner'];
