...
const approvedFunctions = ['checkEligibility', 'recordPoints', 'banUserFromCampaign', 'setAdmin', 'getAdmins', 'setTransitionInterval', 'sortWeeklyReward', 'adjustCampaignValues', 'setUpCampaign', 'getProfile', 'getData', 'approve', 'setMinimumToken', 'owner', 'allowance', 'pause', 'unpause', 'claimReward', 'setScope', 'setConfigId', 'getClaimable', 'configId', 'banOrUnbanUser'];
const readFunctions = ['getProfile',  'getData', 'checkligibility', 'getAdmins', 'toggleAdminStatus', 'owner', 'allowance', 'getClaimable', 'configId'];
