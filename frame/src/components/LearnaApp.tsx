...
export default function LearnaApp() {
    ...
    // const [updatedQuizData, setUpdatedQuizData] = React.useState<{category: string, data: QuizDatum}>(emptyQuizData);
    ...
    }, [emptyQuizData, setQuizData, setQuizCompletion, setIndex, setErrorMessage, setMessage]);
    ...
    const { readTxObject } = React.useMemo(() => {
        ...
        return { readTxObject };
    }, [chainId, setMessage,setErrorMessage, filterTransactionData]);
